...
// Baseado no arquivo consolidado e no dados.js fornecido
// ============================================
...
window.dadosIniciais = {
    ...
    // CONFIGURAÇÕES DE ENTREGA (do arquivo fornecido)
    entrega: {
        taxaGeral: 10.00,
        bairros: [
            { nome: "Centro", valor: 5.00 },
            { nome: "Jardim Planalto", valor: 12.00 },
            { nome: "Vila Nova", valor: 8.00 }
        ]
    },

    // CUPONS DE DESCONTO (do arquivo fornecido)
    cupons: [
        {
            codigo: "PROMO10",
            valor: 10,
    ...
    // OPCIONAIS (do arquivo fornecido, organizados por categoria)
    opcionais: {
    ...
    // SEÇÕES DO CARDÁPIO (do arquivo fornecido)
    secoes: [
        {
            ...
            itens: [
                {
                    ...
                    opcionais: "Panini",
                    opcionais_ativos: [
                        "Ciabatta", "Focaccia", "Lombo piripiri", "Mortadela", "Pastrame",
                        "Presunto cru", "Salame", "Chancliche", "Chancliche apimentado",
                        "Muçarela", "Provolone", "Queijo Prato", "Alichella", 
                        "Melanzane sottolio", "Sardella", "Azeite", "Manteiga", "Maionese",
                        "Pesto de azeitona", "Pesto tradicional (manjericão)", "Alface",
                        "Pepino", "Pimentão", "Rúcula", "Tomate"
                    ],
                    visivel: true,
                    esgotado: false
                },
    ...
    // INFORMAÇÕES DA LOJA (adicionadas para o sistema funcionar)
    loja: {
        nome: "PÃO DO CISO",
        telefone: "(11) 98239-1781",
        whatsapp: "5511982391781",  // Número do vendedor para envio do pedido
